...
export const browserApi = {
  ...
  profiles: {
    ...
    reveal: (id) => browserApi.request('/api/profiles/reveal', { method: 'POST', body: JSON.stringify({ id }) }),
    compat: (id) => browserApi.request('/api/profiles/compat', { method: 'POST', body: JSON.stringify({ id }) }),
